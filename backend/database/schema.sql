...
BEGIN
    ...
    -- Crear recetas
    INSERT INTO recipes (product_id) VALUES (burger_prod_id) RETURNING id INTO burger_recipe_id;
    INSERT INTO recipes (product_id) VALUES (potato_prod_id) RETURNING id INTO potato_recipe_id;
    INSERT INTO recipes (product_id) VALUES (fries_prod_id) RETURNING id INTO fries_recipe_id;
    INSERT INTO recipes (product_id) VALUES (beer1_prod_id) RETURNING id INTO beer_recipe_id;
    INSERT INTO recipes (product_id) VALUES (beer2_prod_id) RETURNING id INTO beer_recipe_id;
    INSERT INTO recipes (product_id) VALUES (salad_prod_id) RETURNING id INTO salad_recipe_id;
    INSERT INTO recipes (product_id) VALUES (pizza1_prod_id) RETURNING id INTO pizza1_recipe_id;
    INSERT INTO recipes (product_id) VALUES (pizza2_prod_id) RETURNING id INTO pizza2_recipe_id;
    INSERT INTO recipes (product_id) VALUES (soda_prod_id) RETURNING id INTO soda_recipe_id;
